...
ActiveRecord::Schema.define(version: 2019_07_08_001137) do
  ...
  create_table "poem_lines", force: :cascade do |t|
    ...
    t.index ["stanza_id"], name: "index_poem_lines_on_stanza_id"
  end
  ...
  create_table "stanzas", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["poem_id"], name: "index_stanzas_on_poem_id"
  end
